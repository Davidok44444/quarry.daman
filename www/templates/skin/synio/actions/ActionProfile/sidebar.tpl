...
{if $view == 'sidebar'}
    <span class="sidebar-hide"><a href="{$albumUrl}album/{$album.id}/full">скрыть</a></span>
{/if}
...
<section class="block block-type-profile-nav">
	<ul class="nav nav-profile">
		...
		<li {if $sAction=='gallery'}class="active"{/if}><a href="{router page='gallery'}index/{$oUserProfile->getId()}">{$aLang.user_menu_profile_gallery}{$count_albums}</a></li>
