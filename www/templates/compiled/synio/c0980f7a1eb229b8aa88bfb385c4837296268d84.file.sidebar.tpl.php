<?php /* Smarty version Smarty-3.1.8, created on 2012-09-04 11:35:45
         compiled from "/home/u224958/quarry.ru/www//templates/skin/synio/actions/ActionProfile/sidebar.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13720740525045af51988f35-46197005%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c0980f7a1eb229b8aa88bfb385c4837296268d84' => 
    array (
      0 => '/home/u224958/quarry.ru/www//templates/skin/synio/actions/ActionProfile/sidebar.tpl',
      1 => 1346660257,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13720740525045af51988f35-46197005',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5045af51ca2469_56378235',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5045af51ca2469_56378235')) {function content_5045af51ca2469_56378235($_smarty_tpl) {?><?php if (!is_callable('smarty_function_hook')) include '/home/u224958/quarry.ru/www//engine/modules/viewer/plugs/function.hook.php';
if (!is_callable('smarty_function_router')) include '/home/u224958/quarry.ru/www//engine/modules/viewer/plugs/function.router.php';
if (!is_callable('smarty_function_json')) include '/home/u224958/quarry.ru/www//engine/modules/viewer/plugs/function.json.php';
if (!is_callable('smarty_function_lang_load')) include '/home/u224958/quarry.ru/www//engine/modules/viewer/plugs/function.lang_load.php';
...
<?php if ($_smarty_tpl->tpl_vars['view']->value=='sidebar'){?>
    <span class="sidebar-hide"><a href="<?php echo $_smarty_tpl->tpl_vars['albumUrl']->value;?>
...
stream/"><?php echo $_smarty_tpl->tpl_vars['aLang']->value['user_menu_profile_stream'];?>
		...
		<li <?php if ($_smarty_tpl->tpl_vars['sAction']->value=='gallery'){?>class="active"<?php }?>><a href="<?php echo smarty_function_router(array('page'=>'gallery'),$_smarty_tpl);?>
index/<?php echo $_smarty_tpl->tpl_vars['oUserProfile']->value->getId();?>
"><?php echo $_smarty_tpl->tpl_vars['aLang']->value['user_menu_profile_gallery'];?>
<?php echo $_smarty_tpl->tpl_vars['count_albums']->value;?>
</a></li>
